...
<?php endforeach; ?>
	...
	<div class="radio-table">
		<table>
			<tr class="radio-table-row first <?php echo ($say_before_dial_action === 'on') ? 'on' : 'off' ?>">
				<td class="radio-cell">
					<input type="radio" class='dial-whom-selector-radio' name="say-before-dial-action" value="on" <?php echo ($say_before_dial_action === 'on') ? 'checked="checked"' : '' ?> />
				</td>
				<td class="content-cell">
					<?php echo AppletUI::AudioSpeechPicker('say-before-dial',
						  'Please wait while we connect your call.'); ?>
				</td>
			</tr>
			<tr class="radio-table-row last <?php echo ($say_before_dial_action === 'off') ? 'on' : 'off' ?>">
				<td class="radio-cell">
					<input type="radio" class='dial-whom-selector-radio' name="say-before-dial-action" value="off" <?php echo ($say_before_dial_action === 'off') ? 'checked="checked"' : '' ?> />
				</td>
				<td class="content-cell">
					<h4>Nothing</h4>
				</td>
	...
	<div class="radio-table">
		<table>
			<tr class="radio-table-row first <?php echo ($recording_enable === 'record-from-answer') ? 'on' : 'off' ?>">
				<td class="radio-cell">
					<input type="radio" class='dial-whom-selector-radio' name="recording-enable" value="record-from-answer" <?php echo ($recording_enable === 'record-from-answer') ? 'checked="checked"' : '' ?> />
				</td>
				<td class="content-cell">
					<h4>Record From Answer</h4>
				</td>
			</tr>
			<tr class="radio-table-row <?php echo ($recording_enable === 'record-from-ringing') ? 'on' : 'off' ?>">
				<td class="radio-cell">
					<input type="radio" class='dial-whom-selector-radio' name="recording-enable" value="record-from-ringing" <?php echo ($recording_enable === 'record-from-ringing') ? 'checked="checked"' : '' ?> />
				</td>
				<td class="content-cell">
